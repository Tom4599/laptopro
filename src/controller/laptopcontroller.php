    ...
    foreach($arraylaptop as $laptop){
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 portfolio-item">
            <div class="card h-100">
                   <a href="#"><img class="card-img-top" src="'.$laptop[url_photo1].'" alt=""></a>
                 <div class="card-body">
                    <h5 class="card-header">
                        <a><a class="btn btn-info" href="#"> '. $laptop[laptop_nom] .' </a> <span class="badge badge-dark">'.$laptop[prix].' jetons</span></a>
                    </h5>
                    <ul class="list-group">
